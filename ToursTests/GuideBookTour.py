...
class GuideBookTest(unittest.TestCase):
    ...
    def test_guideBookTourRegister(self):
        ...
        driver = self.driver
        wait = self.wait
        BasicActions.Registration.verify_and_register(self)
        BasicActions.Registration.enter_email(self)
        BasicActions.Registration.enter_name(self)
        BasicActions.Registration.enter_username(self)
        BasicActions.Registration.enter_password(self)
        BasicActions.Registration.fill_education_list(self)
        BasicActions.Registration.fill_birth_year_list(self)
        BasicActions.Registration.fill_gender_list(self)
        BasicActions.Registration.fill_mailing_adress_area(self)
        BasicActions.Registration.fill_goals_area(self)
        BasicActions.Registration.check_honor_code_box(self)
        BasicActions.Registration.check_terms_of_service_box(self)
        BasicActions.Registration.registration_submit(self)
